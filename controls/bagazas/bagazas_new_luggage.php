...
$dataObj = new ypatybe();
$ypatybe = $dataObj->getYpatybeList();
...
if(isset($_POST['aukstis'])) {
    $bagazoKaina = $cekisObj->generateLuggagePrice($_POST['aukstis'], $_POST['ilgis'], $_POST['plotis'], $_POST['svoris'], $_POST['ypatybe']);
    $naujasCekisID = $cekisObj->createNewCekis($_POST['keleivis'], $bagazoKaina);

    $naujasBagazas = $bagazasObj->newBaggage($_POST['aukstis'], $_POST['ilgis'], $_POST['plotis'], $_POST['svoris'], $_POST['ypatybe'], $_POST['lektuvas'], $_POST['keleivis'], $naujasCekisID);
